...
<div class="bigbox">
	<form action="con_updateinfo.php">
		...
		<div class="qqq">
			添加内容：<br><textarea name="scon" id="" cols="30" rows="10"><?php echo $scon?></textarea>
		</div>
		<div class="qqq">
		...
		<div class="qqq">
			...
			?>
				<?php echo $row3["posname"]?><input type="radio" name="posid" value="<?php echo $row3['posid']?>" <?php if($row3['posid']==$posid){?>
			checked='checked';
			<?php }?>/>
			<?php 
			}
		...
		<div class="qqq">
			<input type="submit" value="修改" disabled="true" id="sub"/>
		</div>
	</form>
</div>
